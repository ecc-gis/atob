...
<qgis symbologyReferenceScale="-1" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="0" minScale="0" version="3.34.4-Prizren" simplifyMaxScale="1" labelsEnabled="0" simplifyDrawingHints="1" styleCategories="Symbology|Labeling|Rendering|Relations" simplifyLocal="1" maxScale="0" simplifyDrawingTol="1">
  <renderer-v2 symbollevels="0" type="singleSymbol" enableorderby="0" referencescale="-1" forceraster="0">
    <symbols>
      <symbol frame_rate="10" clip_to_extent="1" type="line" force_rhr="0" is_animated="0" alpha="1" name="0">
        ...
        <layer id="{643d74f0-b1f3-4625-8999-8bdd6d158120}" class="InterpolatedLine" locked="1" enabled="1" pass="0">
          <Option type="Map">
            <Option type="Map" name="color_ramp_shader">
              ...
              <Option type="Map" name="color_ramp_source">
                ...
                <Option type="Map" name="properties">
                  <Option type="QString" value="215,212,9,255" name="color1"/>
                  <Option type="QString" value="52,186,15,255" name="color2"/>
                  <Option type="QString" value="ccw" name="direction"/>
                  <Option type="QString" value="0" name="discrete"/>
                  <Option type="QString" value="gradient" name="rampType"/>
                  <Option type="QString" value="rgb" name="spec"/>
                  <Option type="QString" value="0;253,174,97,255;rgb;ccw:0.0877404;255,255,191,255;rgb;ccw:0.75;171,221,164,255;rgb;ccw" name="stops"/>
                </Option>
  ...
  <selection mode="Default">
    ...
    <selectionSymbol>
      <symbol frame_rate="10" clip_to_extent="1" type="line" force_rhr="0" is_animated="0" alpha="1" name="">
        <data_defined_properties>
          <Option type="Map">
            <Option type="QString" value="" name="name"/>
            <Option name="properties"/>
        ...
        <layer id="{3d3aa9c2-c905-496a-82ba-803b8fc3b6c4}" class="SimpleLine" locked="0" enabled="1" pass="0">
          <Option type="Map">
